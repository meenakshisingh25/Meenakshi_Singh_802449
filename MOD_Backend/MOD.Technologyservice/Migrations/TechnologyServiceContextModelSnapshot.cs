...
{
    [DbContext(typeof(TechnologyServiceContext))]
    partial class TechnologyServiceContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MOD.TrainingService.Models.Training", b =>
                {
                    b.HasOne("MOD.Userservice.Models.Mentor", null)
                        .WithMany("Trainings")
                        .HasForeignKey("Mentor_id");

                    b.HasOne("MOD.Userservice.Models.user", null)
                        .WithMany("Trainings")
